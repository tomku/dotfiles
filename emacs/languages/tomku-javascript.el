;(add-to-list 'load-path (concat repo-dir "coffee-mode/"))
;(require 'coffee-mode)
;(setq coffee-command "/home/tom/.local/bin/coffee")


;; Borrowed nearly verbatim from the Emacs Starter Kit
(defun esk-javascript-helpers ()
...
;(require 'js2-mode)
;(esk-javascript-helpers)

(provide 'tomku-javascript)
